...
public interface IShippingContainerRepository : IRepository<ShippingContainer>
{
    ...
    /// <summary>
    ///     Retrieves a shipping container with its parcels loaded
    /// </summary>
    /// <param name="id">The unique identifier of the container</param>
    /// <returns>The container with parcels if found, null otherwise</returns>
    Task<ShippingContainer?> GetWithParcelsAsync(Guid id);
